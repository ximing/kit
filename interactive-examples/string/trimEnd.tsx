/**
 * Interactive example for trimEnd function
 *
 * @category string
...
export default function TrimEndExample() {
  const [input, setInput] = useState('  abc  ');
  const [chars, setChars] = useState('');
  const result = trimEnd(input, chars || undefined);
  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial, sans-serif' }}>
      ...
      <div style={{ marginBottom: '20px' }}>
        <p style={{ marginBottom: '8px', fontWeight: 'bold' }}>Output (trailing only):</p>
        <div
          style={{
            padding: '12px',
