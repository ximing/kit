...
id: format
title: format
description: 'Formats a date according to the given format string with support for multiple tokens'
---

# `format`

Formats a date according to the given format string. This function supports multiple format tokens (YYYY, MM, DD, HH, mm, ss, SSS) to customize date output for display purposes.
...
logEvent('User Login');
// => '[2024-01-15 14:30:45] Event: User Login'
