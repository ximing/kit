...
id: mergeDeep
title: mergeDeep
description: 'Recursively merges source objects into target object'
---
...
mergeDeep(obj1, obj2);
console.log(obj1.settings.colors); // ['green'] (arrays are replaced)
```
...
// { primary: 'red', secondary: 'gray' } (deep merge preserved secondary)
