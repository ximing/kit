...
const stringKeys = keys(person).filter((key) => key.includes('name'));
console.log(stringKeys); // ['firstName', 'lastName']
...
const item = { id: 1, name: '商品', price: 99.99 };
