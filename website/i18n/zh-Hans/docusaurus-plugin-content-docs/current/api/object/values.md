...
console.log(userValues); // [1, '张三', 'zhangsan@example.com']
...
console.log(upperValues); // ['张', '三', '30']
```
...
const user = { name: '张三', email: 'zhangsan@example.com', age: 30 };
...
const form = { name: '张三', email: '', phone: '123-456-7890', fax: null };
